...
module.exports = { chats: [
  { _id: '11aaaa', title: jk.name, history: chats[0].history, last: { text: `let's do it` } },
  { _id: '11aaab', title: ag.name, history: chats[1].history, last: { text: `want to meet there?` } },
  { _id: '11aaac', title: em.name, history: chats[2].history, last: { text: `how about top rope?` } },
  { _id: '22aaac', title: 'Touchstone friends', history: chats[3].history, last: { text: `See ya'll soon` } },  
]}
